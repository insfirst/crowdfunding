        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <button type="button" id="deleteCheckedBtn" class="btn btn-danger" style="float:right;margin-left:10px;"><i class=" glyphicon glyphicon-remove"></i> 删除</button>
...
<script type="text/javascript">
            ...
            success:function(result){
                ...
                if(result.success){
                    ...
                    $.each(data,function(i,n){
                        ...
                        content+='        <button type="button" class="btn btn-danger btn-xs" onclick="deleteRole('+n.id+',\''+n.name+'\')"><i class="glyphicon glyphicon-remove"></i></button>';
                        content+='    </td>';
                        content+='</tr>';
                    })
                    $("tbody").html(content);
                    ...
                    if(page.pageno==1){
                        ...
                        contentBar+='<li><a onclick="queryRolePage('+(page.pageno-1)+')">上一页</a></li>';
                    }
                    for(var i=1;i<=page.totalno;i++){
                        ...
                        contentBar+='><a onclick="queryRolePage('+i+')">'+i+'<span class="sr-only"></span></a></li>';
                    }
                    if(page.pageno==page.totalno){
                        contentBar+='<li class="disabled"><a >下一页</a></li>';
                    }else{
                        contentBar+='<li><a onclick="queryRolePage('+(page.pageno+1)+')">下一页</a></li>';
                    }
    ...
    $("#deleteCheckedBtn").click(function(){
        var checkedBox=$("tbody tr td input:checked");

        if(checkedBox.length==0){
            layer.msg("至少选择1个进行删除！", {time:1000, icon:5, shift:6});
            return false;
        }
        var ids=new Array();
