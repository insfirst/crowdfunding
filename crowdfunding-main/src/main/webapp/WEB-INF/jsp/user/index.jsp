...
<button type="button" class="btn btn-danger" id="deleteCheckedBtn" style="float:right;margin-left:10px;"><i class=" glyphicon glyphicon-remove"></i> 删除</button>
			     ...
			     <tr >
				     <td colspan="6" align="center">
						...
						<%-- 
								...
								<c:if test="${page.pageno>1 }">
									<li><a href="#" onclick="onPage(${page.pageno-1})">上一页</a></li>
								</c:if>
								<c:forEach begin="1" end="${page.totalno}" var="num">
									<li 
									<c:if test="${page.pageno==num}">class="active"</c:if>
									><a href="#" onclick="onPage(${num})">${num } <span class="sr-only"></span></a></li>
								</c:forEach>
								<c:if test="${page.pageno==page.totalno }">
									<li class="disabled"><a href="#">下一页</a></li>
								</c:if>
								<c:if test="${page.pageno<page.totalno }">
									<li><a href="#" onclick="onPage(${page.pageno+1})">下一页</a></li>
								</c:if>
							  --%>
							 </ul>
					 </td>
